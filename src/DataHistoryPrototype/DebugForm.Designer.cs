namespace DataHistoryPrototype
{
    partial class DebugForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            textBox1.Size = new Size(801, 429);
            textBox1.TabIndex = 0;
            ...
            label1.TabIndex = 1;
            label1.Text = "Press <Escape>, <Enter> or mouse double click to close.";
            ...
            Name = "DebugForm";
            Text = "Debug";
            KeyPress += DebugForm_KeyPress;
            MouseDoubleClick += DebugForm_MouseDoubleClick;
            ResumeLayout(false);
            PerformLayout();
        }
